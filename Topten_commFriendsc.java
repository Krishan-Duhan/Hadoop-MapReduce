...
public class Topten_commFriendsc {
    ...
    public static class Map2 extends Mapper<LongWritable, Text, IntWritable, Text> {
        ...
        private Text pair_friends = new Text();
    ...
    public static class Reduce2 extends Reducer<IntWritable, Text, Text, Text> {
        ...
        public void reduce(IntWritable key, Iterable<Text> val, Context context) throws IOException, InterruptedException {
            ...
            String result = "";
            for (String p : pair_friends) {
                String[] pair_mut = p.split(":");
                String pair = pair_mut[0];
                String mut_frnds = pair_mut[1];

                result += pair + "\t" + key.toString() + "\t" + mut_frnds + "\n";
            }
            /*
    ...
    public static void main(String[] args) throws Exception {
        ...
        job1.setJarByClass(Topten_commFriendsc.class);
        ...
        if (result1) {
            ...
            job2.setJarByClass(Topten_commFriendsc.class);
